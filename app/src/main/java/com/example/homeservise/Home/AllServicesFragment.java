    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        servicesAdapterAll = new ServicesAdapterAll(new OnServiceSelectedFromAll() {
            ...
            public void onServiceSelected(Services services, View view) {
                ...
                AllServicesFragmentDirections.ActionAllServicesFragmentToDetailsFragment action = AllServicesFragmentDirections.actionAllServicesFragmentToDetailsFragment(services.getSertitle(), services.getSerCat(), services.getSerDiscribtion(), services.getSer_Price(), services.getWith_extra_data(),services.getId(),services.getId());
